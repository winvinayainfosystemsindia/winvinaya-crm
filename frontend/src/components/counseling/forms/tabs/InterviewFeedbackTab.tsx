...
const InterviewFeedbackTab: React.FC<InterviewFeedbackTabProps> = ({
	...
	const handleRecommendJobRoles = () => {
		if (!formData.skills || formData.skills.length === 0) {
			toast.info('Please assess the candidate skills in the "Skill Assessment" tab first to get job recommendations.');
			return;
		}
		...
		try {
			...
			if (candidateSkillNames.length === 0) {
				toast.info('Please assess the candidate skills in the "Skill Assessment" tab first.');
				return;
			}
