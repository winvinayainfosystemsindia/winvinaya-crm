...
const DSRDashboard: React.FC = () => {
	...
	return (
		<Box sx={{ minHeight: '100vh', bgcolor: '#f2f3f3', pb: 8 }}>
			...
			<Box sx={{ bgcolor: 'white', borderBottom: '1px solid #d5dbdb' }}>
				<Container maxWidth="xl" sx={{ py: 2 }}>
					<Breadcrumbs separator={<NavigateNextIcon fontSize="small" />} sx={{ mb: 1 }}>
						...
						<Typography color="text.primary" sx={{ fontWeight: 500 }}>DSR Management</Typography>
					</Breadcrumbs>

					<Stack direction="row" justifyContent="space-between" alignItems="center">
						<Box>
							<Typography variant="h4" sx={{ fontWeight: 300, color: '#16191f' }}>
								Daily Status Reports
							</Typography>
							<Typography variant="body2" color="text.secondary">
								Track work progress, manage submissions, and review team activity.
							</Typography>
						</Box>
						<Button
							variant="contained"
